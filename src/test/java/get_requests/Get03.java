    ...
    public void softAssertion() {
        ...
        given()
                ...
                .body("title", containsString("et itaque necessitatibus maxime molestiae qui quas velitx")
                        ...
                        , "userId", equalTo(1));
        //SOFT ASSERTION yapmak icin bütün body'leri iç içe geçirmemiz gerekiyor.Buna sadece bodylerde ihtiyacimiz olur.
        //SOFT ASSERTION ile tüm hatalari tek tek consolda gördük ama Hard Assertion da ilk hatadan sonra kodlari okumayi biraktigi icin
        //diger hatalari consolda göstermedi.
    }
}
